...
<div class="mid-bar">
                    ...
                    <ul>
                        <li>
                            <div class="dropdown login-manu">
                                <button class="dropdown-toggle" type="button" id="dropdownLogin" data-bs-toggle="dropdown" Area-expanded="false"> <span class="icon">
                                        <svg viewBox="0 0 512 512" style="--svg-font-size: 22px;">
   ...
   c49.363,0,86.579,38.288,86.579,89.071C342.579,180.022,303.743,223.611,256,223.611z" />
                        ...
                        <li>
                            <a href="{{ route('wishlist') }}"><span class="icon"><svg viewBox="0 -28 512.001 512" style="--svg-font-size: 22px;">
                        ...
                        <li>
                            <a href="{{ route('checkout') }}">
                                <span class="icon"><svg viewBox="0 0 512.001 512.001" style="--svg-font-size: 22px;">
                                        ...
                                        <path d="M424.392,424.11H223.77c-6.785,0-13.162-4.674-15.46-11.233l-21.495-63.935c-1.94-5.771-8.207-8.885-13.961-6.934 c-5.771,1.935-8.874,8.19-6.934,13.961l21.539,64.061c5.473,15.625,20.062,26.119,36.31,26.119h200.622 c6.085,0,11.023-4.933,11.023-11.018S430.477,424.11,424.392,424.11z" />
