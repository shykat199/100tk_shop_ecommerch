        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Pending Orders ({{$order_overview[1]??0}})</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
...
@push('js')
    ...
    <script>
        ...
        {{--        table.DataTable({--}}
        {{--            ajax: "@auth('admin'){{route('backend.pending_orders.list')}}@elseauth('seller'){{route('seller.pending_orders.list')}}@endauth",--}}
        {{--            columns: [--}}
        {{--                { data: 'order_no' },--}}
        {{--                { data: 'user_last_name' },--}}
        {{--                { data: 'user_country'},--}}
