<div class="product-card v2">
    <div class="product-img">
        <a href="<?php echo e(route('product', $product->slug)); ?>">
            <?php if($product->images->first()->image ?? false): ?>
                <img src="<?php echo e(asset('uploads/products/galleries/' . $product->images->first()->image ?? '')); ?>"
                    class="b-1" alt="<?php echo e($product->name); ?>">
            <?php endif; ?>
        ...
        <ul class="product-cart">
            <li><a href="javascript:addToWishlist(<?php echo e($product->id); ?>)"><span class="icon"><svg
                            viewBox="0 -28 512.001 512" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <li><a href="javascript:addToCart(<?php echo e($product->id); ?>)"><span class="icon"><svg
    ...
    <div class="product-card-details">
        ...
        <?php if(hasPromotion($product->id)): ?>
            <span class="price" style="font-size: 18px"><?php echo e(currency(promotionPrice($product->id))); ?></span>
            <span class=""><del class="text-secondary"><?php echo e(currency($product->unit_price)); ?></del> <small
                    class="text-secondary">
                    <?php echo e(__('- ')); ?><?php echo e(round((($product->unit_price - promotionPrice($product->id)) / $product->unit_price) * 100)); ?><?php echo e(__('%')); ?></small></span>
        <?php else: ?>
            <?php if($product->discount > 0): ?>
                <div style="display: flex; align-items: center; gap:5px;">
                    <span class="price" style="font-size: 18px"><?php echo e(currency($product->sale_price)); ?> </span>
                    
                    <div>
                        <del class="text-secondary"><?php echo e(currency($product->unit_price)); ?></del>
                        <small class="text-secondary"><?php echo e(__('- ')); ?>
            ...
            <?php else: ?>
                <span class="price" style="font-size: 18px"><?php echo e(currency($product->unit_price)); ?></span>
                <span class=""> </span>
            <?php endif; ?>
        <?php endif; ?>
    </div>
...
<?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/components/frontend/product-card4.blade.php ENDPATH**/ ?>