...
<nav class="side-bar no-print" style="background: #ffff">
    ...
    <div class="side-bar-manu">
        <ul>
            <?php if(auth()->user()->can('browse_dashboard') || auth()->user()->hasRole('super-admin')): ?>
                <li>
                    <a class="<?php if(Request::is('/admin') || Route::is('backend.home')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.home')); ?>">
                        ...
                        <span class="title"> <?php echo e(__('Dashboard')); ?> </span>
                    </a>
                </li>
            <?php endif; ?>
            <!--start orders -->
...
,'admin/courier','admin/delivered','admin/cancelled','admin/returned')): ?> active <?php endif; ?> ">
                        ...
                        <ul>
                            <?php if(auth()->user()->can('browse_orders') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/orders')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.orders.index')); ?>">
            ...
            <?php if(Module::has('ProductManagement') && Module::find('ProductManagement')->isEnabled()): ?>
                <?php if(auth()->user()->can('browse_product_management') || auth()->user()->hasRole('super-admin')): ?>
                    <li class="<?php if(Request::is('admin/products', 'admin/products/*', 'admin/categories', 'admin/categories/*', 'admin/commissions', 'admin/brands', 'admin/brands/*', 'admin/shipping_area', 'admin/shipping_area/*', 'admin/products/wholesale', 'admin/variants/*')): ?> active <?php endif; ?>">
                        <a href="#">
                            <span class="icon">
                            ...
                            <span class="title"><?php echo e(__('Product Management')); ?></span>
                            <span class="arrow">
                                <svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                    <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                    <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                        ...
                        <ul>
                            <?php if(auth()->user()->can('browse_products') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/products', 'admin/products/*/edit')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.products.index')); ?>"><?php echo e(__('All Product')); ?>
                            ...
                            <?php if(auth()->user()->can('create_products') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/products/create')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.products.create')); ?>"><?php echo e(__('Add Product')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('browse_categories') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/categories', 'admin/categories/*/edit')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.categories.index')); ?>"> <?php echo e(__('Category')); ?> </a>
                                </li>
                            <?php endif; ?>

                            <?php if(auth()->user()->can('create_categories') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/categories/create')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.categories.create')); ?>"> <?php echo e(__('Add Category')); ?>

                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('manage_commissions') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/commissions')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.commissions.index')); ?>"> <?php echo e(__('Commissions')); ?>
                            ...
                            <?php if(auth()->user()->can('browse_brands') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/brands', 'admin/brands/*/edit')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.brands.index')); ?>"> <?php echo e(__('Brand')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('create_brands') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/brands/create')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.brands.create')); ?>"> <?php echo e(__('Add Brand')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('browse_shipping_area') || auth()->user()->hasRole('super-admin')): ?>
                                <li><a class="<?php if(Request::is('admin/shipping_area', 'admin/shipping_area/*/edit')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.shipping_area.index')); ?>"> <?php echo e(__('Shipping Area')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('create_shipping_areas') || auth()->user()->hasRole('super-admin')): ?>
                                <li><a class="<?php if(Request::is('admin/shipping_area/create')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.shipping_area.create')); ?>"> <?php echo e(__('Add Shipping Area')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('products_wholesale') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/products/wholesale', 'admin/products/wholesale/edit/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.products.wholesale')); ?>"> <?php echo e(__('Wholesale')); ?> </a>
                                </li>
                            <?php endif; ?>
                            
                                <li>
                                    <a class="<?php if(Request::is('admin/variants/colors', 'admin/variants/colors')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.variant.color')); ?>"> <?php echo e(__('Colors')); ?> </a>
                                </li>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if(Module::has('PromotionManagement') && Module::find('PromotionManagement')->isEnabled()): ?>
                <?php if(auth()->user()->can('browse_promotion_management') || auth()->user()->hasRole('super-admin')): ?>
                    <li class="<?php if(Request::is('admin/promotional_products', 'admin/promotional_products/*', 'admin/coupon*')): ?> active <?php endif; ?>">
                        <a href="#">
                            <span class="icon">
                                <svg viewBox="0 0 22 25" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.3101 11.4708L11.4114 24.1705L22.0005 18.6209V6.125L11.3101 11.4708Z" />
                            ...
                            <span class="title"><?php echo e(__('promotional List')); ?></span>
                            <span class="arrow">
                                <svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                    <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                    <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                        ...
                        <ul>
                            <?php if(auth()->user()->can('browse_promotional_products') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/promotional_products')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.promotional_products.index')); ?>"><?php echo e(__('Promotional Product')); ?>
                            ...
                            <?php if(auth()->user()->can('create_promotional_products') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/promotional_products/create')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.promotional_products.create')); ?>">
                                        <?php echo e(__('Add Products')); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('browse_coupon') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/coupon*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.coupon.index')); ?>"> <?php echo e(__('Coupons')); ?> </a>
                                </li>
                            <?php endif; ?>
                        </ul>
                        <!-- Sub Manu End -->
            ...
            <?php if(Module::has('CustomerManagement') && Module::find('CustomerManagement')->isEnabled()): ?>
                <?php if(auth()->user()->can('browse_customer_management') || auth()->user()->hasRole('super-admin')): ?>
                    <li class="<?php if(Request::is('admin/customers', 'admin/customers/*', 'admin/suspended_customers', 'admin/email_subscriber', 'seller/email_subscriber')): ?> active <?php endif; ?>">
                        <a href="#"><span class="icon"><svg viewBox="0 0 21 22" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="title"><?php echo e(__('Customer Management')); ?></span>
                        ...
                        <!-- Sub Manu Start -->
                        <ul>
                            <?php if(auth()->user()->can('browse_customers') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/customers', 'seller/customers')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.customers.index')); ?>"><?php echo e(__('All Customer')); ?>

                                    </a>
                                </li>
                            <?php endif; ?>
                            
                            <?php if(auth()->user()->can('browse_suspended_customers') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/suspended_customers', 'seller/suspended_customers')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.customers.suspended')); ?>"><?php echo e(__('Suspended Customer')); ?>

                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if(auth()->user()->can('browse_email_subscriber') || auth()->user()->hasRole('super-admin')): ?>
                                <li>
                                    <a class="<?php if(Request::is('admin/email_subscriber', 'seller/email_subscriber')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.email_subscriber')); ?>"><?php echo e(__('Email Subscriber')); ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if(Module::has('SellerManagement') && Module::find('SellerManagement')->isEnabled()): ?>
                <?php if(auth()->user()->can('browse_seller_management') || auth()->user()->hasRole('super-admin')): ?>
                    <li class="<?php if(Request::is('admin/sellers', 'admin/seller_commission', 'admin/sellers/*', 'admin/sellers_earning')): ?> active <?php endif; ?>">
                        <a href="#"><span class="icon"><svg viewBox="0 0 24 23" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="title"><?php echo e(__('Seller Management')); ?></span>
                            <span class="arrow"><svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                    <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                    <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                                </svg></span>
                        ...
                        <ul>
                            <li>
                                <a class="<?php if(Request::is('admin/sellers/create')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.sellers.create')); ?>"><?php echo e(__('Create Seller')); ?>

                                </a>
                            </li>
                            <li>
                                <a class="<?php if(Request::is('admin/sellers')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.sellers.index')); ?>"><?php echo e(__('Seller List')); ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if(auth()->user()->can('browse_content_management') || auth()->user()->hasRole('super-admin')): ?>
                <li class="<?php if(Request::is('admin/banners', 'admin/banners/*', 'admin/product_review', 'admin/product_review/*')): ?> active <?php endif; ?>">
                    <a href="#"><span class="icon"><svg viewBox="0 0 23 21" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="title"><?php echo e(__('Content Management')); ?></span>
                        <span class="arrow"><svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                            </svg></span>
                    ...
                    <ul>
                        <li>
                            <a class="<?php if(Request::is('admin/banners', 'admin/banners/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.banners.index')); ?>"><?php echo e(__('Banner')); ?>

                            </a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/product_review')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.product_review.index')); ?>"><?php echo e(__('Product Review')); ?>
            ...
            <?php endif; ?>
            <?php if(auth()->user()->can('browse_faq_manager') || auth()->user()->hasRole('super-admin')): ?>
                <li class="<?php if(Request::is('admin/faq_category', 'admin/faq_category/*', 'admin/faq_subcategory', 'admin/faq_subcategory/*', 'admin/faq_content', 'admin/faq_content/*')): ?> active <?php endif; ?>">
                    <a href="#"><span class="icon"><svg viewBox="0 0 22 23" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="title"><?php echo e(__('FAQ Manager')); ?></span>
                        <span class="arrow"><svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                            </svg></span>
                    ...
                    <ul>
                        <li>
                            <a class="<?php if(Request::is('admin/faq_category')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.faq_category.index')); ?>"><?php echo e(__('FAQ Category')); ?>

                            </a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/faq_subcategory')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.faq_subcategory.index')); ?>"><?php echo e(__('FAQ SubCategory')); ?>

                            </a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/faq_content', 'admin/faq_content/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.faq_content.index')); ?>"><?php echo e(__('FAQ Content')); ?>
            ...
            <?php endif; ?>
            <?php if(auth()->user()->can('browse_reports') || auth()->user()->hasRole('super-admin')): ?>
                <li class="<?php if(Request::is('admin/stock_report', 'admin/seller_report', 'admin/customer_report')): ?> active <?php endif; ?>">
                    <a href="#"><span class="icon"><svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <rect y="11.4258" width="5.71281" height="8.56921" rx="1" />
                                <rect x="7.14062" width="5.71281" height="19.9948" rx="1" />
                                <rect x="14.2852" y="5.71094" width="5.71281" height="14.282" rx="1" />
                            </svg></span>
                        <span class="title"><?php echo e(__('Report')); ?></span>
                        <span class="arrow"><svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                            </svg></span>
                    ...
                    <ul>
                        <li>
                            <a class="<?php if(Request::is('admin/stock_report')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.stock_report')); ?>"><?php echo e(__('Product (Stock balance)')); ?>

                            </a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/customer_report')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.customer_report')); ?>"><?php echo e(__('Customer Transaction')); ?>

                            </a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/seller_report')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.seller_report')); ?>"><?php echo e(__('Seller info')); ?>
            ...
            <?php endif; ?>
            <li class="<?php if(Request::is('admin/campaign/manage', 'admin/campaign/create', 'admin/campaign*')): ?> active <?php endif; ?>">
                    <a href="#">
                        <span class="icon">
                            <svg viewBox="0 0 22 25" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.3101 11.4708L11.4114 24.1705L22.0005 18.6209V6.125L11.3101 11.4708Z" />
                        ...
                        <span class="title"><?php echo e(__('Landing Page')); ?></span>
                        <span class="arrow">
                            <svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                    ...
                    <ul>
                        <li>
                            <a class="<?php if(Request::is('admin/campaign/create')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.campaign.create')); ?>"><?php echo e(__('Create Page')); ?></a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/campaign/manage')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.campaign.index')); ?>"><?php echo e(__('Campaign List')); ?></a>
                        </li>
                    </ul>
                    <!-- Sub Manu End -->
                </li>
            <?php if(auth()->user()->can('browse_user_permission') || auth()->user()->hasRole('super-admin')): ?>
                <li class="<?php if(Request::is('admin/permissions', 'admin/permissions/*', 'admin/users', 'admin/users/*', 'admin/roles', 'admin/roles/*')): ?> active <?php endif; ?>">
                    <a href="#"><span class="icon"><svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0)">
                        ...
                        <span class="title"><?php echo e(__('User Permission')); ?></span>
                        <span class="arrow"><svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                            </svg></span>
                    ...
                    <!-- Sub Manu Start -->
                    <ul>
                        <?php if(auth()->user()->can('browse_users') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/users', 'admin/users/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.users.index')); ?>"><?php echo e(__('Users')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->user()->can('browse_roles') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/roles', 'admin/roles/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.roles.index')); ?>"><?php echo e(__('Roles')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->user()->can('browse_permissions') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/permissions', 'admin/permissions/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.permissions.index')); ?>"><?php echo e(__('Permission')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                    <!-- Sub Manu End -->
            ...
            <?php endif; ?>
            <?php if(auth()->user()->can('browse_website_setting') || auth()->user()->hasRole('super-admin')): ?>
                <li class="<?php if(Request::is('admin/popup_setting','admin/contact-infos', 'admin/tag-manager/manage','admin/pixels/manage', 'admin/website_setting/header', 'admin/website_setting/pages', 'admin/website_setting/pages/*', 'admin/website_setting/appearance', 'admin/website_setting/announcements', 'admin/website_setting/announcements/*', 'admin/website_setting/currency', 'admin/website_setting/currency/*', 'admin/website_setting/language', 'admin/website_setting/notice/*','admin/paymentgeteway/manage','admin/smsgeteway/manage','admin/courierapi/manage')): ?> active <?php endif; ?>">
                    <a href="#"><span class="icon"><svg viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="title"><?php echo e(__('Website Setting')); ?></span>
                        <span class="arrow"><svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                            </svg></span>
                    ...
                    <!-- Sub Manu Start -->
                    <ul>
                        <?php if(auth()->user()->can('browse_header') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/website_setting/header')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.website_setting.header')); ?>"><?php echo e(__('Header')); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->user()->can('browse_pages') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/website_setting/pages', 'website_setting/pages/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.website_setting.pages')); ?>"><?php echo e(__('Pages')); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->user()->can('browse_appearance') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/website_setting/appearance')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.website_setting.appearance')); ?>"><?php echo e(__('Appearance')); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->user()->can('browse_announcements') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/website_setting/announcements', 'admin/website_setting/announcements/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.announcements.index')); ?>"><?php echo e(__('Announcements')); ?>

                                </a>
                            </li>
                        <?php endif; ?>

                        <?php if(auth()->user()->can('browse_currency') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/website_setting/currency', 'admin/website_setting/currency/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.currency.index')); ?>"><?php echo e(__('Currency')); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->user()->can('browse_language') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/website_setting/language', 'admin/website_setting/language/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.language.index')); ?>"><?php echo e(__('Language')); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->user()->can('browse_notice') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/website_setting/notice', 'admin/website_setting/notice/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.notice.index')); ?>"><?php echo e(__('notice')); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->user()->can('manage_contact_info') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/contact-infos')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.contact-infos.index')); ?>">
                                    <?php echo e(__('Contact Infos')); ?>
                        ...
                        <?php if(auth()->user()->can('browse_popup') || auth()->user()->hasRole('super-admin')): ?>
                            <li>
                                <a class="<?php if(Request::is('admin/popup_setting')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.website_setting.popup')); ?>"><?php echo e(__('Popup')); ?></a>
                            </li>
                        <?php endif; ?>
                        <li>
                            <a class="<?php if(Request::is('admin/tag-manager/manage')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.tagmanagers.index')); ?>"><?php echo e(__('Manage GMT')); ?></a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/pixels/manage')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.pixels.index')); ?>"><?php echo e(__('Manage Pixel')); ?></a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/paymentgeteway/manage')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.paymentgeteway.manage')); ?>"><?php echo e(__('Payment Gateway')); ?></a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/smsgeteway/manage')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.smsgeteway.manage')); ?>"><?php echo e(__('SMS Gateway')); ?></a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/courierapi/manage')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.courierapi.manage')); ?>"><?php echo e(__('Courier API')); ?></a>
                        </li>
                    </ul>
                    <!-- Sub Manu End -->
                </li>
            ...
            <?php if(auth()->user()->hasRole('super-admin')): ?>
                <li>
                    <a class="<?php if(Route::is('backend.withdraws.index') || Route::is('backend.withdraws.show')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.withdraws.index')); ?>">
                        <i class="fa-solid fa-credit-card"></i>
                        <span class="title"> <?php echo e(__('Withdraw Manager')); ?> </span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if(auth()->user()->can('browse_blog_list') || auth()->user()->hasRole('super-admin')): ?>
                <li class="<?php if(Request::is('admin/blog/category', 'admin/blog/category/*', 'admin/blog', 'admin/blog/*')): ?> active <?php endif; ?>">
                    <a href="">
                        <span class="icon"><svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <rect y="11.4258" width="5.71281" height="8.56921" rx="1" />
                                <rect x="7.14062" width="5.71281" height="19.9948" rx="1" />
                        ...
                        <span class="title"> <?php echo e(__('blog List')); ?> </span>
                        <span class="arrow"><svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                            </svg></span>
                    ...
                    <ul>
                        <li>
                            <a class=" <?php if(Request::is('admin/blog/category', 'admin/blog/category/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.blog.category.index')); ?>"><?php echo e(__('Blog Category')); ?>

                            </a>
                        </li>
                        <li>
                            <a class="<?php if(Request::is('admin/blog', 'admin/blog/*')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.blog.index')); ?>"><?php echo e(__('blog')); ?>
            ...
            <?php if(auth()->user()->can('browse_stock_management') || auth()->user()->hasRole('super-admin')): ?>
                <li class="<?php if(Route::is('backend.stocks.index') || Route::is('backend.stocks.show')): ?> active <?php endif; ?>">
                    <a href="#" class="<?php if(Route::is('backend.stocks.index') || Route::is('backend.stocks.show')): ?> active <?php endif; ?>">
                        <span class="icon">
                        ...
                        <span class="title"><?php echo e(__('Stock Management')); ?></span>
                        <span class="arrow"><svg viewBox="0 0 13 8" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1.47082" y1="2" x2="6.32702" y2="6.8562" stroke-linecap="round" />
                                <line x1="0.75" y1="-0.75" x2="7.61771" y2="-0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 12.3281 2)" stroke-linecap="round" />
                            </svg></span>
                    ...
                    <ul>
                        <li>
                            <a class="<?php if(Route::is('backend.stocks.index') || Route::is('backend.stocks.show')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.stocks.index')); ?>"><?php echo e(__('Stock List')); ?>
            ...
            <?php if(auth()->user()->can('browse_notifications') || auth()->user()->hasRole('super-admin')): ?>
                <li>
                    <a class="<?php if(Request::is('admin/notifications')): ?> active <?php endif; ?>" href="<?php echo e(route('backend.notifications.index')); ?>">
                        <span class="icon">
                            <i class="fa fa-bell" Area-hidden="true"></i>
                        </span>
                        <span class="title"><?php echo e(__('Notifications')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
        </ul>
...
<?php /**PATH /var/www/html/100tk_shop_ecommerch/resources/views/backend/includes/side_bar.blade.php ENDPATH**/ ?>