                    ...
                    <div class="contact-infos my-3">
                        <?php $__currentLoopData = getContactsInfos(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="single-item">
                                <h6 class="d-inline-block my-1 contact-number"><?php echo e($item->value['number'] ?? ''); ?></h6> <small class="d-inline-block ms-2"><?php echo e($item->value['title'] ?? ''); ?></small>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make('frontend.layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/100tk_shop_ecommerch/resources/views/frontend/pages/product-details-2.blade.php ENDPATH**/ ?>