                                ...
                                <div class="col-md-6">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>Sub Total</td>
                                            <td class="text-end">
                                                <span class="sub-total sub-total"><?php echo e($order->total_price); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Shipping Fee</td>
                                        ...
                                        <tr class="fw-semibold">
                                            <td>Total</td>
                                            <td class="text-end">
                                                <span class="grand-total"><?php echo e($order->total_price + ($order->shipping_cost ?? 0)); ?></span>
                                            </td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/my/100_shop/app/Modules/Backend/OrderManagement/Resources/views/orders/edit_order.blade.php ENDPATH**/ ?>