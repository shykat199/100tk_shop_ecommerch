                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <a href="<?php echo e(route('backend.permissions.create')); ?>" methods="get" class="float-end">
                                <button class="btn theme-btn"><?php echo e(__('Add Permission')); ?></button>
                            </a>
                        </div>
                    </div>
    ...
    <script>
        $(function() {
            ...
            $(document).ready(function(){
                ...
                table.DataTable({
                    ajax: "<?php echo e(route('backend.permission.list')); ?>",
                    columns: [
                        { data: 'id' },
                        { data: 'name' },
                        { data: 'guard_name' },
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/backend/pages/user_permission/permissions/index.blade.php ENDPATH**/ ?>