    ...
    <div class="mybazar-login-wrapper">
        <div class="login-wrapper">
            ...
            <div class="login-body">
                ...
                <form name="LoginForm" id="LoginForm" action="<?php echo e(url('seller/login')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="input-group">
                        <span>
                            <img src="<?php echo e(URL::to('/backend')); ?>/img/icons/Lock.svg" alt="">
                        </span>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="button-group ">
                    ...
                    <a href="#" class="btn login-btn" onclick="fillup('seller@maantheme.com','seller22')"><?php echo e(__('Seller')); ?></a>

                </div>
                <div class="login-footer">
                    <a href="<?php echo e(route('seller.password.request')); ?>">
                        <span><img src="<?php echo e(URL::to('/backend')); ?>/img/icons/lock1.svg" alt=""></span><?php echo e(__('Forgot Password?')); ?></a>
                    <span>
                        <a href="<?php echo e(route('seller.registration')); ?>"><?php echo e(__('Registration')); ?></a>
                        <a href="<?php echo e(URL::to('/')); ?>"><span><img src="<?php echo e(URL::to('/backend')); ?>/img/icons/global.svg" alt=""></span><?php echo e(__('Frontend')); ?></a>
                    </span>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/backend/pages/auth/seller/login.blade.php ENDPATH**/ ?>