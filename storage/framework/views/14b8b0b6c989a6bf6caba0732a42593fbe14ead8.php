...
<div class="modal fade" id="pathao" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('backend.bulk-order.pathao')); ?>" id="order_sendto_pathao" method="post">
                <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function () {
        $.ajax({
            url: "<?php echo e(route('pathao.stores')); ?>", // API route
            type: "GET",
            dataType: "json",
        ...
        $('#pathaocity').on('change', function () {
            ...
            let zoneUrl = "<?php echo e(route('get-zones', ':city_id')); ?>";
        ...
        $('#pathaozone').on('change', function () {
            ...
            let areaUrl = "<?php echo e(route('areas', ':zone_id')); ?>";
