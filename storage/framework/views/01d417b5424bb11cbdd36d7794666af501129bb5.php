...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('customer.register')); ?>" method="post" >
        ...
        <div class="input-group">
            ...
            <?php if($errors->has('last_name')): ?> <p><?php echo e($errors->first('last_name')); ?></p> <?php endif; ?>
        </div>
        <div class="input-group">
            <span><img src="<?php echo e(asset('customer/img/icons/Call.svg')); ?>" alt=""></span>
            <input type="number" name="mobile" value="<?php echo e(old('mobile')); ?>" class="form-control" placeholder="Number">
...
<?php echo $__env->make('frontend.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/frontend/auth/register.blade.php ENDPATH**/ ?>