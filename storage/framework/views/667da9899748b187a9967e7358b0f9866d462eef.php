...
<div class="mid-bar">
                    ...
                    <ul>
                        <li>
                            <div class="dropdown login-manu">
                                <button class="dropdown-toggle" type="button" id="dropdownLogin" data-bs-toggle="dropdown" Area-expanded="false"> <span class="icon"><svg viewBox="0 0 512 512">
   ...
   c49.363,0,86.579,38.288,86.579,89.071C342.579,180.022,303.743,223.611,256,223.611z" />
                        ...
                        <li>
                            <a href="<?php echo e(route('wishlist')); ?>"><span class="icon"><svg viewBox="0 -28 512.001 512">
                        ...
                        <li>
                            <a href="<?php echo e(route('checkout')); ?>">
                                <span class="icon"><svg viewBox="0 0 512.001 512.001">
...
<!-- Mid Bar End -->
<?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/frontend/includes/mid-bar.blade.php ENDPATH**/ ?>