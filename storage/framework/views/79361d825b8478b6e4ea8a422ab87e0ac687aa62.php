        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="input-group">
                    <input type="number" id="minimum_qty" name="minimum_qty" class="form-control" min="1" value="1" value="<?php echo e($product->minimum_qty ?? ''); ?>" required>
                </div>
            </div>
            <div class="col-lg-2">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/100_shop/app/Modules/Backend/ProductManagement/Resources/views/products/form.blade.php ENDPATH**/ ?>