    ...
    <div class="container">
        <div class="row align-items-center">
                ...
                <div class="top-bar-left">
                    <ul>
                        <li>
                            <a href="#">
                                            <span class="icon">
											<svg viewBox="0 0 473.806 473.806"><path d="M374.456,293.506c-9.7-10.1-21.4-15.5-33.8-15.5c-12.3,0-24.1,5.3-34.2,15.4l-31.6,31.5c-2.6-1.4-5.2-2.7-7.7-4
			...
			c0.8,0,1.5-0.1,2.3-0.2C469.556,223.306,474.556,216.306,473.256,209.006z"/>
                                ...
                                <span class="text"><?php echo e(maanAppearance('hotline_number')); ?></span>
                            </a>
                        </li>
                        <?php if(maanHeader('enable_tracking_order')): ?>
                            <li>
                                <a href="<?php echo e(route('customer.order')); ?>">
                                            <span class="icon">
											<svg  viewBox="0 0 512 512"><path d="M386.689,304.403c-35.587,0-64.538,28.951-64.538,64.538s28.951,64.538,64.538,64.538
			...
			c8.912,0,16.134-7.223,16.134-16.134C196.303,151.895,189.08,144.672,180.168,144.672z"/></svg>
                                    ...
                                    <span class="text"><?php echo e(__('Track Your Order')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
...
<!-- Top Bar End -->
<?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/frontend/includes/top-bar.blade.php ENDPATH**/ ?>