...
<div class="product-card product-shop-list-items">
    ...
    <div class="product-card-details">
        ...
        <?php if(hasPromotion($product->id)): ?>
            <span class="price" style="font-size: 18px"><?php echo e(currency($product->unit_price,2)); ?></span>
        <?php else: ?>
...
<?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/components/frontend/product-card3.blade.php ENDPATH**/ ?>