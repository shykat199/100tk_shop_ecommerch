...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        function removeFromCart(key, id) {
            swal({
                title: "<?php echo e(__('Really!?')); ?>",
                text: "<?php echo e(__('Are you sure you want remove this form cart?')); ?>",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((whileDelete) => {
                if (whileDelete) {
                    ...
                    $.ajax({
                        ...
                        swal("<?php echo e(__('Poof! Your item has been removed!')); ?>", {
                            icon: "success",
                        }).then(value => {
...
<?php echo $__env->make('frontend.layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/customer/checkout/checkout_guest.blade.php ENDPATH**/ ?>