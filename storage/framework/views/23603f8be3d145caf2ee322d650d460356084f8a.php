...
<?php $__env->startSection('title','Delivered Orders - '); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Delivery Orders (<?php echo e($order_overview[6]??0); ?>)</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
    ...
    <script>
        ...
        $(function() {
            ...
            $(document).ready(function(){
                ...
                table.DataTable({
                    ajax: "<?php if(auth()->guard('admin')->check()): ?><?php echo e(route('backend.delivered_orders.list')); ?><?php elseif(auth()->guard('seller')->check()): ?><?php echo e(route('seller.delivered_orders.list')); ?><?php endif; ?>",
                    columns: [
                        { data: 'order_no' },
                        { data: 'user_last_name' },
                        { data: 'user_country'},
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/100_shop/app/Modules/Backend/OrderManagement/Resources/views/orders/delivered_orders.blade.php ENDPATH**/ ?>