    ...
    <div class="content-body">
        <div class="container">
            <div class="content-tab-title d-flex justify-content-between align-items-center">
                <h4><?php echo e(__('Campaign Information')); ?></h4>
            </div>
        </div>
        <!-- Tab Content Start -->
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="add-category" role="tabpanel" Area-labelledby="add-category-tab">
                <div class="container">
                    <form action="<?php echo e(route('backend.campaign.update')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data" name="editForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="banner" value="<?php echo e($edit_data->banner); ?>"  id="banner" >
                                <img src="<?php echo e(asset('uploads/'.$edit_data->banner)); ?>" alt="" class="edit-image mt-2">
...
unset($__errorArgs, $__bag); ?>" name="image_one" value="<?php echo e($edit_data->image_one); ?>"  id="image_one" >
                                <img src="<?php echo e(asset('uploads/'.$edit_data->image_one)); ?>" alt="" class="edit-image">
...
unset($__errorArgs, $__bag); ?>" name="image_two" value="<?php echo e($edit_data->image_two); ?>"  id="image_two" >
                                <img src="<?php echo e(asset('uploads/'.$edit_data->image_two)); ?>" alt="" class="edit-image">
...
unset($__errorArgs, $__bag); ?>" name="image_three" value="<?php echo e($edit_data->image_three); ?>"  id="image_three" >
                                <img src="<?php echo e(asset('uploads/'.$edit_data->image_three)); ?>" alt="" class="edit-image">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="product_img">
                                <?php $__currentLoopData = $edit_data->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img src="<?php echo e(asset('uploads/'.$image->image)); ?>" class="edit-image border" alt="" />
                                    <a href="<?php echo e(route('backend.campaign.image.destroy',['id'=>$image->id])); ?>" class="btn btn-xs btn-danger waves-effect waves-light"><i class="fa fa-trash"></i></a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                        <!-- col end -->
...
<?php $__env->startPush('custom-script'); ?>
    ...
    <script src="<?php echo e(asset('backend/js/vendor/flatpickr.min.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/js/vendor/form-pickers.init.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/100_shop/resources/views/backend/pages/campaign/edit.blade.php ENDPATH**/ ?>