			...
			c49.363,0,86.579,38.288,86.579,89.071C342.579,180.022,303.743,223.611,256,223.611z"/></svg>
                        ...
                        <li>
                            <a href="<?php echo e(route('checkout')); ?>">
                                ...
                                <span class="number" id="cart-count"><?php echo e(Cookie::has('cart') ? count(get_object_vars(json_decode(Cookie::get('cart')))) : 0); ?></span>
                            </a>
                        </li>
                    </ul>
...
<!-- Mid Bar End -->
<?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/resources/views/customer/includes/mid-bar.blade.php ENDPATH**/ ?>