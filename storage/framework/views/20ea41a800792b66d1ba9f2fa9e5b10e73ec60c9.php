        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="input-group">
                    <input type="number" name="minimum_qty" class="form-control" min="1" value="1" value="<?php echo e($product->minimum_qty ?? ''); ?>" required>
                </div>
            </div>
            <div class="col-lg-2">
                                    ...
                                    <div class="vAreants">
                                        ...
                                        <?php $__currentLoopData = $product->productstock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $productstock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="input-group mb-4 d-flex align-items-center">
                                                ...
                                                <input type="number" class="form-control" value="<?php echo e($productstock->quantities); ?>" placeholder="Enter quantity" name="quantities[]">
                                                <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group overflow-visible">
                                <input name="quantity" min="1" type="number" class="form-control" placeholder="0" value="<?php echo e($product->quantity); ?>" required>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u849325218/domains/100tkshop.com/public_html/app/Modules/Backend/ProductManagement/Resources/views/products/form.blade.php ENDPATH**/ ?>