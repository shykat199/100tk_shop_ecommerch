    ...
    <div class="content-body">
        <div class="container">
            <div class="content-tab-title d-flex justify-content-between align-items-center">
                <h4><?php echo e(__('Tag Manager Create')); ?></h4>
                <div class="page-title-right">
                    <a href="<?php echo e(route('backend.tagmanagers.index')); ?>" class="btn btn-primary text-white">
                        Manage Pages
                    </a>
                </div>
            </div>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="add-category" role="tabpanel"
                ...
                <div class="container">
                    <form action="<?php echo e(route('backend.tagmanagers.update')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/100_shop/resources/views/backend/pages/tagmanager/edit.blade.php ENDPATH**/ ?>