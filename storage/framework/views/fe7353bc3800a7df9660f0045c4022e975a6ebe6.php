        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="add-category" role="tabpanel" Area-labelledby="add-category-tab">
                <div class="container content-title">
                    <h4><?php echo e(__('Category Informationcxzcz')); ?></h4>
                </div>
                <div class="container">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/100tk_shop_ecommerch/app/Modules/Backend/ProductManagement/Resources/views/categories/create.blade.php ENDPATH**/ ?>