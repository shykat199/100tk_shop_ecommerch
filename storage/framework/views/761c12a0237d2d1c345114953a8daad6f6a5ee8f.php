    ...
    <div class="container">
        <div class="row align-items-center">
			...
			c0.8,0,1.5-0.1,2.3-0.2C469.556,223.306,474.556,216.306,473.256,209.006z"/>
                                ...
                                <strong class="text text-black" style="font-size: 20px"><?php echo e(maanAppearance('hotline_number')); ?></strong>
                            </a>
                        </li>
			...
			c8.912,0,16.134-7.223,16.134-16.134C196.303,151.895,189.08,144.672,180.168,144.672z"/></svg>
                                    ...
                                    <strong class="text text-black" style="font-size: 20px"><?php echo e(__('Track Your Order')); ?></strong>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
                        ...
                        <?php if(maanHeader('show_language')): ?>
                            <li class="d-none">
                                <div class="dropdown help-manu">
                                    <button class="dropdown-toggle" type="button" id="dropdownHelpManu" data-bs-toggle="dropdown" Area-expanded="false"><?php echo e(lang('name')); ?></button>
                                    <ul class="dropdown-menu" Area-labelledby="dropdownHelpManu">
                                        <?php $__currentLoopData = languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><a href="javascript:changeLanguage(<?php echo e($language->id); ?>)"><?php echo e($language->name); ?></a></li>
...
<!-- Top Bar End -->
<?php /**PATH /var/www/html/100tk_shop_ecommerch/resources/views/frontend/includes/top-bar.blade.php ENDPATH**/ ?>